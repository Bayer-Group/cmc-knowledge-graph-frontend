export const environment = {
    ...
    apis : {
      graphData: {
        ...
        classTableIncoming:"http://localhost:8080/classtable/incoming",
        classtableCSV: "http://localhost:8080/classtable/generate-csv"
      },
      autocomplete: {
    ...
    adalConfig: {
      authority: "xxx",
      clientId: 'xxx',
      redirectUri: 'http://cmc-kge-backend:4400/',
      protectedResourceMap: {
      },
      postLogoutRedirectUri: 'http://cmc-kge-backend:4400/'
    }
  };
